...
if(downloadFiles):
    ...
    df = pd.read_excel('https://www.kba.de/SharedDocs/Downloads/DE/Statistik/Fahrzeuge/FZ28/fz28_2022_09.xlsx?__blob=publicationFile&v=4', sheet_name=4,header=[7,8,9,10,11]) #skiprows=[0,1,2,3,4,5,6,101,102]) 
