...
if(downloadFiles):
    ...
    df = pd.read_csv('/Users/carstenschmotz/Downloads/ShockData.csv', sep=',', nrows=15, usecols=["latitude", "longitude", "speed"])
print("shit")
...
df.to_sql('location', 'sqlite:///2023-amse-cs/data/locationData.sqlite', if_exists='replace', index=False)
